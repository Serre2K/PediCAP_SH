---
title: "PediCAP_analysis_script_bacterial_threshold_50K"
author: "SH&JPRR"
date: "2024-05-27"
...
write.csv(genus_cont_removed, "~/data/Servaas/PediCAP/R_output/Decontam/genus_cont_removed_bacterial50K.csv")
...
write.csv(species_cont_removed, "~/data/Servaas/PediCAP/R_output/Decontam/species_cont_removed_bacterial50K.csv")
...
genus_merged <- genus_merged[genus_merged$Bacterial_reads >= 50000,]
species_merged <- species_merged[species_merged$Bacterial_reads >= 50000,]
...
# otu.rarecurve1k_species = rarecurve(rarefaction_species, step = 1000, label = T, cex = 0.6,  xlab= "Sequences per sample with step 1000 with bacterial read threshold 50K", ylab= "OTU's")
# otu.rarecurve10k_species = rarecurve(rarefaction_species, step = 10000, label = FALSE, cex = 0.6,  xlab= "Number of species reads with step 10000 with bacterial read threshold 50K", ylab= "OTU's")
# otu.rarecurve10k_species = rarecurve(rarefaction_species, step = 10000, label = FALSE, cex = 0.6,  xlab= "Number of species reads with step 10000 with bacterial read threshold 50K", ylab= "OTU's")
...
# otu.rarecurve1k_genus = rarecurve(rarefaction_genus, step = 1000, label = FALSE, cex = 0.6,  xlab= "Number of genus reads with step 1000 with bacterial read threshold 50K", ylab= "OTU's") # to see if it affects low read samples
# otu.rarecurve1k_genus = rarecurve(rarefaction_genus, step = 1000, label = FALSE, cex = 0.6,  xlab= "Number of genus reads with step 1000 with bacterial read threshold 50K", ylab= "OTU's")
# otu.rarecurve10k_genus = rarecurve(rarefaction_genus, step = 10000, label = FALSE, cex = 0.6,  xlab= "Number of genus reads with step 10000 with bacterial read threshold 50K", ylab= "OTU's")
# otu.rarecurve10k_genus = rarecurve(rarefaction_genus, step = 10000, label = FALSE, cex = 0.6,  xlab= "Number of genus reads with step 10000 with bacterial read threshold 50K", ylab= "OTU's")
...
# species non parametric, genus parametric
```
...
shannon_analysis2 <- shannon_analysis[2:3,]
metadata_pcoa2 <- metadata_pcoa[1:55,]
